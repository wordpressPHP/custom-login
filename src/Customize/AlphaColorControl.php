...
namespace PassyCo\CustomLogin\Customize;

/**
 * Class AlphaColorControl
 *
 * @package PassyCo\CustomLogin\Customize
 */
class AlphaColorControl extends \WP_Customize_Color_Control {
