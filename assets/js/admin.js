(function ($) {
   ...
   * @type {*|HTMLElement}
   */
  var cl_container = $('.CustomLogin__container'),
    cl_header = $('.CustomLogin__header'),
    cl_save = $('input[id="CustomLogin__save"]');
   ...
   ************************************
   */
  var cl_main_group = $('.CustomLogin__main .group'),
    cl_sections_menu = $('.CustomLogin__sections-menu');
  ...
  if (activetab != '' && $(document.getElementById(activetab)).length) {
    ...
    first_group.fadeIn();
    cl_save.val('Save ' + $('.CustomLogin__sidebar .CustomLogin__sections-menu li:first a').text());
  }
   ...
   ************************************
   */
  var sticky = $('#CustomLogin__sticky'),
   ...
   ************************************
   */
  $(document.body).on('click', '#CustomLogin__sticky input[id="cl_save"]', function (e) {
    $this = $(this);
    form = $('.CustomLogin__main > div.group:visible > form');
